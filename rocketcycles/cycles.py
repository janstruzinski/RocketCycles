...
class ORSC_LRE:
    ...
    def analyze_cycle(self, mdot_total, dP_OP, dP_FP, mdot_crossflow_fuel_over_mdot_fuel=None):
        ...
        # Calculate combustion chamber performance. It does not matter wrt which propellant CC pressure at injector is
        # established, as it will be imposed by the residuals that their total pressure is the same.
